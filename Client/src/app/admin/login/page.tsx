        ...
        <div className="w-full max-w-sm bg-[#0f121d]/60 backdrop-blur border border-white/5 rounded-xl p-8">
          ...
          <div className="flex items-center gap-2 mb-6">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${
              resetStep === 'username' ? 'bg-cyan-500/20 text-cyan-400 border border-cyan-500/30' :
              'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30'
            }`}>1</div>
            <div className="h-px flex-1 bg-white/10" />
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${
              resetStep === 'otp' ? 'bg-cyan-500/20 text-cyan-400 border border-cyan-500/30' :
              ['password'].includes(resetStep) ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' :
              'bg-white/5 text-gray-600 border border-white/10'
            }`}>2</div>
            <div className="h-px flex-1 bg-white/10" />
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${
              resetStep === 'password' ? 'bg-cyan-500/20 text-cyan-400 border border-cyan-500/30' :
              'bg-white/5 text-gray-600 border border-white/10'
            }`}>3</div>
          </div>
          ...
          {/* Step 2: OTP */}
          {resetStep === 'otp' && (
            <form onSubmit={(e) => { e.preventDefault(); setResetStep('password') }} className="flex flex-col gap-4">
              <div className="relative">
              ...
              <button type="button" onClick={() => { setResetStep('username'); setError(''); setSuccess('') }}
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#07090e] p-6">
      <div className="w-full max-w-sm bg-[#0f121d]/60 backdrop-blur border border-white/5 rounded-xl p-8">
        ...
        <div className="mt-6 text-center border-t border-white/5 pt-4">
          <Link href="/" className="text-xs text-gray-500 hover:text-cyan-400 font-semibold transition-colors flex items-center justify-center gap-1.5">
            ← Back to Portfolio
          </Link>
        </div>
      </div>
